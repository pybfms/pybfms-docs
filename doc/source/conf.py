# -*- coding: utf-8 -*-
#
# PyBFMs documentation build configuration file
...
# Locate source-directory paths
# We need to add a path for each BFM

sourcedir = os.path.dirname(os.path.abspath(__file__))

# TODO: Add in pybfms
sys.path.insert(0, os.path.join(sourcedir, "pybfms", "src"))

for d in os.listdir(os.path.join(sourcedir, "bfms")):
    print("d=" + str(d))
    srcdir = os.path.join(sourcedir, "bfms", d, "src")
    print("srcdir=" + str(srcdir))
    if os.path.isdir(srcdir):
        print("Add path " + str(srcdir))
...
print("Note: sys.path: " + str(sys.path))
...
# Github repo
issues_github_path = "pybfms/pybfms"
...
latex_documents = [
  ('index', 'pybfms.tex', u'PyBFMs Documentation',
...
man_pages = [
    ('index', 'PyBFMs', u'PyBFMs Documentation',
...
texinfo_documents = [
  ('index', 'PyBFMs', u'PyBFMs Documentation',
   u'Matthew Ballance and Contributors', 'PyBFMs', 'Python Bus Functional Models',
   'Miscellaneous'),
]
